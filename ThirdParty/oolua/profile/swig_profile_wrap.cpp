...
#define SWIGTYPE_p_ProfileAnotherBase swig_types[0]
#define SWIGTYPE_p_ProfileBase swig_types[1]
#define SWIGTYPE_p_ProfileDerived swig_types[2]
#define SWIGTYPE_p_ProfileMultiBases swig_types[3]
#define SWIGTYPE_p_Set_get swig_types[4]
...
#define SWIG_name      "swig_profile"
#define SWIG_init      luaopen_swig_profile
#define SWIG_init_user luaopen_swig_profile_user

#define SWIG_LUACODE   luaopen_swig_profile_luacode
...
extern "C" {
#endif
static int _wrap_new_Set_get(lua_State* L) {
  int SWIG_arg = 0;
  Set_get *result = 0 ;
  
  SWIG_check_num_args("Set_get",0,0)
  result = (Set_get *)new Set_get();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Set_get,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Set_get_set(lua_State* L) {
  int SWIG_arg = 0;
  Set_get *arg1 = (Set_get *) 0 ;
  double arg2 ;
  
  SWIG_check_num_args("set",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("set",1,"Set_get *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("set",2,"double");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Set_get,0))){
    SWIG_fail_ptr("Set_get_set",1,SWIGTYPE_p_Set_get);
  }
...
static int _wrap_Set_get_get(lua_State* L) {
  int SWIG_arg = 0;
  Set_get *arg1 = (Set_get *) 0 ;
  double result;
  
  SWIG_check_num_args("get",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("get",1,"Set_get const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Set_get,0))){
    SWIG_fail_ptr("Set_get_get",1,SWIGTYPE_p_Set_get);
  }
  
  result = (double)((Set_get const *)arg1)->get();
...
static void swig_delete_Set_get(void *obj) {
Set_get *arg1 = (Set_get *) obj;
delete arg1;
}
static swig_lua_method swig_Set_get_methods[] = {
    {"set", _wrap_Set_get_set}, 
    {"get", _wrap_Set_get_get}, 
    {0,0}
};
static swig_lua_attribute swig_Set_get_attributes[] = {
    {0,0,0}
};
static swig_lua_class *swig_Set_get_bases[] = {0};
...
static int _wrap_ProfileBase_increment_a_base(lua_State* L) {
  ...
  ProfileBase *arg2 = (ProfileBase *) 0 ;
  
  SWIG_check_num_args("increment_a_base",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("increment_a_base",1,"ProfileBase *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("increment_a_base",2,"ProfileBase *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ProfileBase,0))){
    SWIG_fail_ptr("ProfileBase_increment_a_base",1,SWIGTYPE_p_ProfileBase);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_ProfileBase,0))){
    SWIG_fail_ptr("ProfileBase_increment_a_base",2,SWIGTYPE_p_ProfileBase);
  }
  
  (arg1)->increment_a_base(arg2);
...
static int _wrap_new_ProfileAnotherBase(lua_State* L) {
  int SWIG_arg = 0;
  ProfileAnotherBase *result = 0 ;
  
  SWIG_check_num_args("ProfileAnotherBase::ProfileAnotherBase",0,0)
  result = (ProfileAnotherBase *)new ProfileAnotherBase();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ProfileAnotherBase,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_ProfileAnotherBase(void *obj) {
ProfileAnotherBase *arg1 = (ProfileAnotherBase *) obj;
delete arg1;
}
static swig_lua_method swig_ProfileAnotherBase_methods[] = {
    {0,0}
};
static swig_lua_attribute swig_ProfileAnotherBase_attributes[] = {
    {0,0,0}
};
static swig_lua_class *swig_ProfileAnotherBase_bases[] = {0};
...
static int _wrap_new_ProfileDerived(lua_State* L) {
  ...
  SWIG_check_num_args("ProfileDerived::ProfileDerived",0,0)
  result = (ProfileDerived *)new ProfileDerived();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ProfileDerived,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_ProfileDerived(void *obj) {
ProfileDerived *arg1 = (ProfileDerived *) obj;
delete arg1;
}
...
static int _wrap_new_ProfileMultiBases(lua_State* L) {
  int SWIG_arg = 0;
  ProfileMultiBases *result = 0 ;
  
  SWIG_check_num_args("ProfileMultiBases::ProfileMultiBases",0,0)
  result = (ProfileMultiBases *)new ProfileMultiBases();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_ProfileMultiBases,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_ProfileMultiBases(void *obj) {
ProfileMultiBases *arg1 = (ProfileMultiBases *) obj;
delete arg1;
}
...
static void *_p_ProfileMultiBasesTo_p_ProfileAnotherBase(void *x, int *SWIGUNUSEDPARM(newmemory)) {
...
static swig_type_info _swigt__p_ProfileDerived = {"_p_ProfileDerived", "ProfileDerived *", 0, 0, (void*)&_wrap_class_ProfileDerived, 0};
static swig_type_info _swigt__p_ProfileMultiBases = {"_p_ProfileMultiBases", "ProfileMultiBases *", 0, 0, (void*)&_wrap_class_ProfileMultiBases, 0};
static swig_type_info _swigt__p_Set_get = {"_p_Set_get", "Set_get *", 0, 0, (void*)&_wrap_class_Set_get, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_ProfileAnotherBase,
  &_swigt__p_ProfileBase,
  &_swigt__p_ProfileDerived,
  &_swigt__p_ProfileMultiBases,
  &_swigt__p_Set_get,
};
...
static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_ProfileAnotherBase,
  _swigc__p_ProfileBase,
  _swigc__p_ProfileDerived,
  _swigc__p_ProfileMultiBases,
  _swigc__p_Set_get,
};
