...
namespace OOLUA
{
	...
	template<typename T>
	bool push2lua(lua_State* const s, T * const &  value,OOLUA::Owner);
	template<typename T>
	bool push2lua(lua_State* const s, lua_acquire_ptr<T>&  value);
	template<typename T>
	bool push2lua(lua_State* const s, T const &  value);
	...
	template<typename T>
	bool pull2cpp(lua_State* const s, T *&  value);
	template<typename T>
	bool pull2cpp(lua_State* const s, T&  value);
	template<typename T>
	bool pull2cpp(lua_State* const s, cpp_acquire_ptr<T>&  value);	
